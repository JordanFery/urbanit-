...
export default function Residence() {
    ...
    return (
        <section id="residence" className="bg-[var(--color-bg2)] w-full flex flex-row">


            <div className="flex bg-white flex-col  place-items-center justify-center w-1/2 ">
            ...
            <div className="w-1/2 flex">
                ...
                <div className="flex flex-col w-1/2 text-[var(--color-font)] pl-10">
