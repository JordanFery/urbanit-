...
export default function Quartier() {
    ...
    return (
        // <section id="quartier" className="bg-[var(--color-bg2)] w-full flex grid grid-cols-6 flex-row scroll-mt-14">
        ...
        <section id="quartier" className="bg-[var(--color-bg2)] w-full grid grid-cols-1 md:grid-cols-6 scroll-mt-14">
            ...
            {/* <div className="relative md:col-start-4 md:col-span-3 col-span-6 justify-center place-items-center md:place-items-start  md:pl-4 flex bg-[var(--color-bg1)] flex-col pt-2">
