...
export default function Strategique() {
    ...
    return (
        ...
        <section className="bg-[var(--color-title)] h-full max-h-screen overflow-y-auto p-6 text-white text-justify">
            ...
            <div className="py-4">
                ...
                <ul>
                    ...
                    <li>- Bus : lignes 14 – 15 – 16 au pied de la Résidence et bustram ligne 1 à proximité</li>
                </ul>
            </div>
            <div className="py-4">
                <div className='flex w-full justify-evenly mb-4'>
                ...
                <ul>
                    ...
                    <li>- 2 autres écoles maternelles et élémentaires dans le quartier</li>
                    <li>- Enseignement privé : École Sainte Jeanne d’Arc (de la maternelle au CM2)</li>
                </ul>
            </div>
